...
1.) clone this repo: https://github.com/learn-co-curriculum/phase-3-ruby-group-project-rack-react
2.) deleted unnecessary .github and .canvas folders / files
3.) run `rm -rf .git` to delete the hidden .git folder so that the project is no longers recognized as a git repo
4.) run `npx create-react-app frontend` to create your frontend
5.) cd into the new 'frontend'
6.) repeat step 3
